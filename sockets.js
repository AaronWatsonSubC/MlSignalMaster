...
exports.ListenSocket = function (server, config) {
    ...
    io.sockets.on('connection', function (client) {
        ...
        client.on('time_req', function (time_req) {
            ...
            // VVB: (TODO) Return information about rooms count and number of clients (ask Timur for required information)
            if (infoParsed['get_stat'] == true)
                infoParsed['stat'] = GetStat();
